...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (律師-委託人關係)
...
If you are a lawyer (律師), legal researcher, or other legal professional:

- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (執業疏失)
...
- **Professional Rules**: Members of the Taiwan Bar Association (台灣律師聯合會) and regional bar associations must comply with applicable professional conduct rules (律師倫理規範) under the Attorney Regulation Act (律師法) when using AI tools
...
1. Checking the official source (Laws and Regulations Database of the Republic of China — law.moj.gov.tw)
2. Verifying the provision is currently in force (現行有效) and has not been amended (修正) or abolished (廢止)
3. Reading the full context of cited provisions
4. Consulting case law (判決) and explanatory materials (立法理由) for interpretation
...
This Tool aggregates data from official Taiwanese legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **law.moj.gov.tw** | Authoritative | Statute text, regulations, judicial interpretations (primary reference) |
| **Constitutional Court (憲法法庭)** | Authoritative | Constitutional interpretations and judgments |
| **Official Gazette (總統府公報)** | Authoritative | Official notifications, statutory instruments |
...
- 月旦法學知識庫 (Lawdata), 法源法律網 (LawBank), 司法院法學資料檢索系統

These services provide editorial oversight, comprehensive annotations (法學評論), and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Taiwanese law changes continuously through new acts (法律), amendments (修正), and court decisions (裁判)
...
- Even "fresh" data may be outdated if recent amendments were published in the Official Gazette (總統府公報)
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (現行法規)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (修正) after the last database update
  - Abolished (廢止) but not yet removed from the database
  - Subject to transitional rules (過渡條款) affecting its applicability
...
1. **Complete case law** -- Coverage of the Supreme Court (最高法院), Supreme Administrative Court (最高行政法院), Constitutional Court (憲法法庭), and lower court decisions is limited; do not rely solely on this for case law research
2. **Historical statute versions** -- Limited availability of historical provision wording (歷史沿革)
3. **Legal commentary** -- No editorial annotations, academic commentary (學說), or practice guides
4. **Unpublished decisions** -- Lower court decisions and administrative rulings largely absent
5. **Full legislative history** -- Limited coverage of Legislative Yuan (立法院) debates and committee reports
...
- **International Law Blind Spots**: Cannot fully assess obligations under agreements Taiwan has concluded
...
- This includes but is not limited to:
  - Professional malpractice claims (執業疏失訴訟)
...
- **Sensitive Matters**: For privileged legal matters (保密義務), consider on-premise deployment

### Competence and Diligence

Using this Tool does not reduce your professional obligations to:

- Exercise independent legal judgment (獨立專業判斷)
...
2. **Official Verification**: Cross-check ALL results with official sources (law.moj.gov.tw)
3. **Commercial Databases**: Use professional legal databases (月旦法學知識庫, 法源法律網) for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Taiwanese-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Taiwanese-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (law.moj.gov.tw)
...
- **COMPLY** with Taiwan Bar Association (台灣律師聯合會) professional ethics rules regarding AI tool use and client confidentiality
- **DISCLOSE** to clients if required by professional rules (律師倫理規範)
