/**
 * validate_eu_compliance — Check EU alignment status for an Taiwanese statute.
 */
  ...
  if (euRefCount === 0) {
    return {
      results: {
        ...
        eu_references_found: 0,
        warnings: [],
        recommendations: ['No EU cross-references found for this Taiwanese statute. Taiwanese is an EU Member State; EU references indicate transposition obligations.'],
      },
      _metadata: generateResponseMetadata(db),
    };
  }
