#!/usr/bin/env tsx
/**
 * Database builder for Taiwanese Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Taiwanese Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Taiwanese statute text',
              );
